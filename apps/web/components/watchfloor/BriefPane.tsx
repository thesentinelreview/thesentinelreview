  ...
  return (
    ...
    >
      <header className="px-3 py-2 border-b border-zinc-900 flex items-center justify-between flex-none gap-3">
        ...
        {/* Static AI switch (ON) — chrome only this pass */}
        <span className="inline-flex items-center gap-2 flex-none">
          <span className="text-[9px] font-data uppercase tracking-[0.22em] text-emerald-300">AI ON</span>
          <span className="relative inline-block w-9 h-5 rounded-full border bg-emerald-500 border-emerald-400">
            <span className="absolute top-[2px] left-[18px] w-[14px] h-[14px] rounded-full bg-white shadow-[0_0_8px_rgba(52,211,153,0.65)]" />
          </span>
        </span>
      </header>
