...
// Headless top-sources list — meant to render inside a parent panel that owns
// the card chrome (header + days badge).
    ...
    <>
      <div className="space-y-2.5">
        {sources.map((source, index) => {
          const badge =
            platformDisplay[source.platform] ?? {
              label: source.platform.toUpperCase(),
              cls: "bg-slate-700/30 text-slate-400 border-slate-600/30",
            };
