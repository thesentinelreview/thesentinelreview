        ...
        <div className="flex items-center gap-3 flex-wrap">
          {PLATFORMS.map(({ key, label }) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-1.5 px-2.5 py-0.5 bg-slate-800/40 border border-slate-700/50 rounded hover:border-slate-600 transition-colors"
              >
                <Circle
                  className={`w-2 h-2 ${
          ...
          <div className="ml-auto flex items-center gap-3 text-xs">
            <div
              ...
              className="flex items-center gap-2 px-2.5 py-0.5 bg-slate-800/40 border border-slate-700/50 rounded"
            >
