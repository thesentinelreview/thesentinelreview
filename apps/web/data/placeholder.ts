...
// Rebase occurred_at to now - minutes_ago so placeholder events always look current
function rebaseEvent(e: MapEvent): MapEvent {
  return { ...e, occurred_at: new Date(Date.now() - e.minutes_ago * 60_000).toISOString() };
}
