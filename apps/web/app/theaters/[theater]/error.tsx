...
export default function TheaterDetailError({
  error,
  unstable_retry,
}: {
  ...
  useEffect(() => {
    console.error("[/theaters/[theater]] render error:", error);
  }, [error]);
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-bold text-slate-100 mb-1">
              Theater page temporarily unavailable
            </h2>
            <p className="text-sm text-slate-400 leading-relaxed">
              This theater could not be rendered right now. Other theaters and the dashboard remain available.
            </p>
            {error?.digest && (
